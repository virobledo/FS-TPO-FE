    ...
    perfiles: [
      {
        ...
        texto:
          'It is a very didactic and very useful book for all people who perform physical activities. ¡Excellent book!',
      },
      {
        img: 't2',
      ...
      },
      {
        ...
        texto:
          'Very good book, excellent manner of explaining the excercises and training tips; applying in a practical way day by day in the gym the theory from Intelligent muscle training.',
      },
      {
        img: 't4',
        ...
        texto:
          'Thanks for sharing your knowledge in this excellent book, I take it everywhere. Very recomended. A great person and a genius as teacher.',
      },
      {
        img: 't5',
        ...
        texto:
          'It is a brilliant book for me, I loved it, excellent and easy to understand. Nicolás is a great professional on his job. ¡¡Thousands of thanks Nico!! For sharing all your knowledge, and I am very happy about having you as a teacher. Greetings and lots of succes.',
      },
      {
        img: 't6',
        nombre: 'Joan Torino',
      ...
      },
      {
        ...
        texto:
          '¡Excellent book! Clear and precise lenguaje. It contibutes with the essential knowledge everyone which likes sports needs to know',
      },
      {
        img: 't8',
        ...
        texto:
          '¡¡Excellent!! ¡Congratulations Nico! I loved it, very didactic and esay to understand, I recomend it to my students. Hugs',
      },
      {
        img: 't9',
        nombre: 'Ahmed Molina',
      ...
      },
      {
        ...
        texto:
          'Very good book, didactic and easy to read… It seems that most people insist on difficult explanations, but you comprehend it is the contrary that has to be done to achieve the purpose of teaching and being understandable. I thank you now for such good book and we wait for you to give a training soon here in Perú',
      },
      {
        img: 't12',
        ...
        texto:
          '!!!Thank you Nico for being an excellent teacher and placing your knowledge in these books which are a wonder!!! ¡¡¡Big hug!!!',
      },
      {
        img: 't13',
      ...
      },
      {
        ...
        oficio:
          'Nutrition Degree specialized in Physical Activities and Sports',
        texto:
          'Very good books for students. The information is clear and easy to take, I have read both of them and gave them to a colleague I am training to work in the gym.',
      },
      {
        img: 't15',
        nombre:
          'Powerlifting Athlete and Senior Technician in physical Activities and Sports',
        oficio:
          'Atleta de Levantamiento de Potencia y Técnico Superior en Actividad Física y Deportes',
        texto:
          'It is an honor to have such an excellent and demanded edition. Very clear and direct information.',
      },
    ],
    personas: [
      { img: '1' },
